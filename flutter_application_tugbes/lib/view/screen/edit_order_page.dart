...
class EditOrderPage extends StatefulWidget {
  ...
  const EditOrderPage({super.key, required this.sewa});
...
class _EditOrderPageState extends State<EditOrderPage> {
  ...
  void initState() {
    super.initState();
    _tanggalMulaiController.text = widget.sewa.tanggalMulai;
    _tanggalSelesaiController.text = widget.sewa.tanggalSelesai;
  }
  ...
  bool _validateFile(String? pathFile) {
    if (pathFile == null && widget.sewa.content.isEmpty) {
      return true;
    }
    return false;
  }
            ...
            SizedBox(
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Image.network(widget.sewa.content),
                    ],
                  ),
                ),
              ),
                    ...
                    onPressed: () async {
                      ...
                      final putSewa = SewaInput(
                          ...
                          imageUrl: _namaFile != null || _pathFile != null
                              ...
                              : widget.sewa.content);
                      DataResponse? res =
                          await _dataService.putSewa(widget.sewa.id, putSewa);
                      if (res!.status == 200) {
