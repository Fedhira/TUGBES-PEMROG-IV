...
class TambahBillboardPage2 extends StatefulWidget {
  final String kode;
  final String nama;
  ...
  @override
  State<TambahBillboardPage2> createState() => _TambahBillboardPage2State();
}

class _TambahBillboardPage2State extends State<TambahBillboardPage2> {
                      ...
                      child: FlutterMap(
                        options: MapOptions(
                          ...
                          initialCenter: const LatLng(
                              -6.916053058182122, 107.6208371361958),
                          initialZoom: 12.0,
                          keepAlive: true,
                        ),
                        children: [
                ...
                Container(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      final postBillboard = BillboardInput(
                          kode: widget.kode,
                          nama: widget.nama,
                      ...
                      DataResponse? res =
                          await _dataService.postBillboard(postBillboard);
                      if (res!.status == 201) {
